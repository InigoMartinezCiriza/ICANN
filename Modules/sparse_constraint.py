...
class SparseConstraint(tf.keras.constraints.Constraint):
    def __init__(self, prob_connection):
        ...
        -----------
            prob_connection: float
                Probability of a weight being non-zero. Must be in (0, 1].
        """
    ...
    def __call__(self, w):
        ...
        -----------
            w: tf.Tensor
                Weight tensor to which the sparsity constraint is applied.

        Returns:
        -----------
            w * self.mask: tf.Tensor
                Weight tensor after applying the sparsity mask.
        """
    ...
    def get_config(self):
        """
        Returns the configuration of the constraint for serialization.
        
        Returns:
        -----------
            config: dict
                Dictionary containing the configuration of the constraint.
        """
