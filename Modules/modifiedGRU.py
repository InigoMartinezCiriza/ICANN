...
class ModifiedGRUCell(tf.keras.layers.Layer):
    def __init__(self, units, alpha, kernel_constraint = None, recurrent_constraint = None, **kwargs):
        ...
        -----------
            ...
            kernel_constraint: tf.keras.constraints.Constraint
                Constraint function applied to the `kernel` weights matrix
                (input transformations: W_in, Wl_in, Wg_in).
            recurrent_constraint: tf.keras.constraints.Constraint
    ...
    def build(self, input_shape):
        """
        Build the weights for the modified GRU cell.
    ...
    def call(self, inputs, states):
        """
        Perform a single time step update of the modified GRU cell.
        
        Args:
        -----------
            inputs: tf.Tensor
                Input tensor at the current time step.
            states: list of tf.Tensor
                List containing the previous hidden state.
        
        Returns:
        -----------
            h_new: tf.Tensor
                The updated hidden state.
            [h_new]: list of tf.Tensor
    ...
    def get_config(self):
        """
        Returns the configuration of the ModifiedGRU cell.
...
class ModifiedGRU(tf.keras.layers.Layer):
    def __init__(self, units, return_sequences=False, return_state=False, alpha=0.1, kernel_constraint = None, recurrent_constraint = None, **kwargs):
        ...
        return_sequences: bool
            Whether to return the full sequence or only the last output.
        return_state: bool
            Whether to return the last state.
        alpha: float
            Time-step over time constant factor.
        kernel_constraint: tf.keras.constraints.Constraint
            Constraint function applied to the `kernel` weights matrix
    ...
    def call(self, inputs, initial_state=None, training=None, mask=None):
        """
        Perform the forward pass of the ModifiedGRU layer.
        ...
        mask: tf.Tensor, optional
            Mask tensor for the inputs.

        Returns:
        -----------
        rnn_layer: tf.Tensor or list of tf.Tensor
            The output tensor(s) from the RNN layer.
        """
    ...
    def get_initial_state(self, inputs):
         """
         Get the initial state for the RNN layer based on the inputs.
         ...
         Returns:
         -----------
             initial_state: list of tf.Tensor
                 Initial state tensor(s).
        """
         return self.rnn_layer.get_initial_state(inputs)

    def reset_states(self, states=None):
        """
        Reset the states of the RNN layer.
        
        Args:
        -----------
            states: list of tf.Tensor, optional
                States to reset to. If None, resets to zeros.
        """
    ...
    def get_config(self):
        """
        Returns the configuration of the ModifiedGRU layer.
